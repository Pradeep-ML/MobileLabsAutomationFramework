...
Set ObjAfterSwipe = MobiDevice("Web Browser").MobiWebView("WebView").MobiWebLink("TL")
...
Set ObjAfterScroll = MobiDevice("Web Browser").MobiWebView("WebView").MobiWebLink("Contact")
