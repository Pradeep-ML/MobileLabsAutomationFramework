'##########################################################################################################
'Objective: Login to PhoneLookup and Test  Picker 
...
arrToPropValues = Array( 1 , True)

arrROProps = Array("nativeclass" ,  "name" , "itemscount")
arrROPropValues = Array("Picker" , "Picker" , 300 )
...
Environment("ExpectedResult") = "Picker  screen should be displayed"

'Set object for Button
Set objMobiPicker = MobiDevice("PhoneLookup").MobiPicker("Picker")


' Step1: Navigate to UIPickerView in the control list in PhoneLookUp
'#######################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
...
blnResult = VerifyChildObjects(objMobiPicker , "recursive" , 0)
...
blnResult = VerifyChildObjects(objMobiPicker , "nonrecursive" , 0)
...
blnResult = VerifyGetItemUIPicker(objMobiPicker  , 0  ,  , "Item 1" , "withindexonly")
...
Environment("ExpectedResult") = "Correct index value should be returned"
blnResult = VerifyGetItemUIPicker(objMobiPicker  , 299  , 0 , "Item 300" , "withindexonly") 
...
Environment("ExpectedResult") = "Error should be thrown"
blnResult = VerifyGetItemUIPicker(objMobiPicker , -20  , 0   ,  "Item 1" , "withindexonly")
...
Environment("ExpectedResult") = "Error should be thrown"
blnResult = VerifyGetItemUIPicker(objMobiPicker , 301  , 0 ,   "Item 4" , "withindexonly")
...
Environment("ExpectedResult") = "Error should be thrown"
blnResult = VerifyGetItemUIPicker(objMobiPicker ,   , 0 , , "withonlyoneparameter")
...
blnResult = VerifyGetItemUIPicker(objMobiPicker  ,  2 , 0 , "Item 3" , "withbothparameters")
...
strText = "Item 1,Item 2,Item 3,Item 4,Item 5,Item 6"
...
Environment("ExpectedResult") = "Entire Picker text should be returned"
blnResult = VerifyGetScrollText(objMobiPicker  , "" , True , 0 , "withoutwheelcount")
...
blnResult = VerifyRowCount(objMobiPicker , 300 , 1)
...
Set objBottomWheelZero = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 300")
...
Set objTopWheelZero =MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 0")
...
Set objTop = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 17")
Set objMid = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 18")
Set objBottom = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 19")
...
Environment("ExpectedResult") = "Correct object should be displayed"
Set objTop = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 1")
Set objMid = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 2")
Set objBottom = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 3")
...
Set objTop = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 29")
Set objMid = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 30")
Set objBottom = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 28")
...
Environment("ExpectedResult") = "Correct object should be displayed"
Environment("WheelNumber")  = 0 
Set objTop = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 11")
Set objMid = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 12")
Set objBottom = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 13")
...
Environment("WheelNumber")  = 0
blnResult = VerifySelect(objMobiPicker  , "selectstring" , "Item 1" , objTopWheelZero)
...
'Environment("Description") = "Verify swipe with only direction eDOWN"
'Environment("ExpectedResult") = "Correct object should be displayed"
'objMobiPicker.Scroll eTOP
'wait 4
'Set objTopWheelZero = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 1")
'blnResult = VerifySwipe(objMobiPicker , eDOWN , eSLOW  ,    ,    , objTopWheelZero)
'
''Step : Execute Swipe with direction eUP
''##########################################################
'intStep = intStep+1
...
'Environment("Description") = "Verify swipe with only direction eUP"
'Environment("ExpectedResult") = "Correct object should be displayed"
'objMobiPicker.Scroll eBOTTOM
'wait 4
'Set objBottomWheelZero = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 300")
'blnResult = VerifySwipe(objMobiPicker , eUP , eFAST  ,  ,  , objBottomWheelZero)
'
'
'
''Step : Execute Swipe with direction eDOWN  , velocity  eFAST 
...
'wait 4
'Set objTopWheelZero = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 0")
'blnResult = VerifySwipe(objMobiPicker , eDOWN , eMEDIUM  ,   ,  , objTopWheelZero)
'
''Step : Execute Swipe with direction eUP  , velocity  eMEDIUM 
''##########################################################
'intStep = intStep+1
...
'wait 4
'Set objBottomWheelZero = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 300")
'blnResult = VerifySwipe(objMobiPicker , eUP , eMEDIUM  ,   ,  , objBottomWheelZero)
'
'
'
''Step : Execute Swipe with direction eDOWN  , velocity  eSLOW
...
'wait 4
'Set objBottomWheelZero = MobiDevice("PhoneLookup").MobiPicker("Picker").MobiElement("text:=Item 300")
'blnResult = VerifySwipe(objMobiPicker , eUP , eSLOW  ,   ,  , objBottomWheelZero)
'
'
'
