...
' Step1 Execute GetROProperty when element is visible to user
'#######################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Execute GetROProperty method"
...
Environment("ExpectedResult") = "GetROProperty should get the correct run-time value for a property."
Set objMobiElement = MobiDevice("PhoneLookup").MobiElement("UILabel")
arrROProps = Array("visibletouser")
arrROvalues = Array(True)
strResult =VerifyGetROProperty(objMobiElement, arrROProps, arrROvalues)

' Step1 Execute GetROProperty when element is not visible to user
'#######################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Execute GetROProperty method"
...
Set objMobiElement = MobiDevice("PhoneLookup").MobiElement("UILabel")
arrROProps = Array("visibletouser")
arrROvalues = Array(False)
MobiDevice("PhoneLookup").MobiList("lstControls").Swipe eDOWN 
wait 3
strResult =VerifyGetROProperty(objMobiElement, arrROProps, arrROvalues)
...
MobiDevice("PhoneLookup").MobiList("lstControls").Swipe eUP
wait 3
...
'Open ScrollView screen
 Do Until MobiDevice("PhoneLookup").MobiElement("UIScrollView").GetROProperty("visibletouser")
    MobiDevice("PhoneLookup").MobiElement("UILabel").Swipe eDOWN , eSLOW
    wait 2
Loop
MobiDevice("PhoneLookup").MobiElement("UILabel").Swipe eDOWN , eSLOW
wait 2
MobiDevice("PhoneLookup").MobiList("lstControls").Select("UIScrollView")
Wait 3
...
blnResult = VerifyChildObjects(objMobiElement1, "nonrecursive" , 8 )
...
blnResult = VerifyChildObjects(objMobiElement1, "recursive" , 8 )
...
'Swipe
Set obj_Bottom =MobiDevice("PhoneLookup").MobiElement("accessibilitylabel:= View 7")
...
Set obj_Top = MobiDevice("PhoneLookup").MobiElement("accessibilitylabel:= View 0")
