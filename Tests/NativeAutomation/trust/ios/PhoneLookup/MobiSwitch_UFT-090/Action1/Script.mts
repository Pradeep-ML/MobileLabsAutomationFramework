...
arrTOProperties = Array("enabled","visible")
arrTOPropertiesValue = Array("True","True")
arrROProperties = Array("name","nativeclass")
arrROPropertiesValue = Array("Switch" ,"Switch")
...
blnResult = VerifyChildObjects(objMobiSwitch, "nonrecursive" , 0 )
...
blnResult = VerifyChildObjects(objMobiSwitch, "recursive" ,0)
...
' Step 27:  Execute Set  to  activate  on activated switch
'#######################################################
