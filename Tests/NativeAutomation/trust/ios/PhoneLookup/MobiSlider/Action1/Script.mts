...
arrProp = Array("nativeclass" , "name" , "enabled")
appPropVal = Array("Slider" , "Slider" , "True")
...
strResult = VerifySetNativeAutomation(objMobiSlider ,60)
...
blnResult = VerifyChildObjects(objMobiSlider, "nonrecursive" , 0)
...
blnResult = VerifyChildObjects(objMobiSlider, "recursive" ,0)
...
'val1 = 83s
'val2 = 89
'If ValueToSet  >= val1 AND ValueToSet <= val2 Then
'	Print "pass"
'Else
'    Print "fail"
'End If
...
'MobiDevice("PhoneLookup").MobiSlider("Slider_NativeAutomation").Set 100
'wait 3
'MobiDevice("PhoneLookup").Sync
'Print MobiDevice("PhoneLookup").MobiSlider("Slider_NativeAutomation").GetROProperty("percentage")
