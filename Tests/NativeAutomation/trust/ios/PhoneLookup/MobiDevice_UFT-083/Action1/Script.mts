...
blnFlag = VerifyCheckProperty(objMobiDevice, "name","PhoneLookup", 5000, True)
...
Set ObjAfterSwipe = MobiDevice("PhoneLookup").MobiElement("name:=CustomTextController")
'Environment("StepsToReproduce") = Environment("StepsToReproduce") & Environment("StepName") & "." & intStep & ": " &_
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a MobiDevice"
...
arrProperty = Array("nativeautomation")
arrPropertyValue = Array("true")
