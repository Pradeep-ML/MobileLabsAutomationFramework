...
' Step30:  Execute Select with index as input
...
'Step 30:  Execute Click  without coordinates
'#######################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
...
blnFlag = VerifySwipe(objMobList , eDOWN, , 30,80,ObjAfterSwipe)
...
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a mobile list"
blnFlag = VerifySwipe(objMobList ,eUP,eSLOW,30, ,ObjAfterSwipe)
...
Environment("ExpectedResult") = "Simulates a gesture on a mobile list"
Set ObjAfterSwipe = MobiDevice("PhoneLookup").MobiList("lstControls").MobiElement("ListControlBottom")
'MobiDevice("PhoneLookup").MobiList("lstControls").Swipe eDOWN , eSLOW , 30 , 70 
...
arrProperty = Array("name","nativeclass" , "itemscount")
arrPropertyValue = Array("List","Table", "23")
...
' Step 30:  Execute Select  for last item with String  as input
'#######################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
...
Wait 3
objMobList.Swipe eDOWN , eFAST , 30 , 80
Wait 3
