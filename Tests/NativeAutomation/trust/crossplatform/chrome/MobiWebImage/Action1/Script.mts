...
' If Google chrome asks for Sign-In, then skip it
SkipChromeSignIn
...
'Step 21  IsOccluded  (For IsOccluded when object is not in view without passing co-ordinates.)
'###############################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
...
'Step 22 IsOccluded  (For IsOccluded when object is not in view by  passing co-ordinates.)
'###############################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Verify IsOccluded" 
...
'Step 23 IsOccluded  (For IsOccluded when object is  in view without passing co-ordinates.)
'###############################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Verify IsOccluded" 
...
'Step 24 IsOccluded  (For IsOccluded when object is in view by passing co-ordinates.)
'###############################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Verify IsOccluded" 
...
OpenURL strURL2 , MobiDevice("Web Browser").MobiWebImage("IMG_TutorialsLibrary") ,3
