...
' Step1: Navigate to Login screen
'Expected Result: Login screen should be displayed
intStep = intStep+1
...
'strResult  = NavigateScreenOnPhoneLookup("Login"  , objMobiCheck , "")
...
strResult = VerifyChildObjects(objMobiCheck , "recursive" , 0)
...
"Execute ChildObjects on MobiCheckBox." & VBNewLine
Environment("ExpectedResult") = "ChildObjects should return the count of children (if any)."
strResult = VerifyChildObjects(objMobiCheck , "nonrecursive" , 0)

'Step 22:  Execute Click with boundary coordinates top left
'#######################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
...
'Step 22:  Execute Click with with boundarycoords bottom right
'#######################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment.Value("Description") = "Execute Click on MobiButton with boundarycoords bottom  left"
...
arrProps = Array("nativeclass", "name")
arrValues = Array("android.widget.CheckBox", "RememberMe")
...
arrValues = Array("True", "Remember Me")
