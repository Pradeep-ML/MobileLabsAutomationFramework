...
NavigateScreenOnPhoneLookupNative "Controls"  , objMobiSwitch , "ToggleButton" , objList 
...
strResult = VerifyChildObjects(objMobiSwitch , "recursive" , 0)
...
"Execute ChildObjects on MobiCheckBox." & VBNewLine
Environment("ExpectedResult") = "ChildObjects should return the count of children (if any)."
strResult = VerifyChildObjects(objMobiSwitch , "nonrecursive" , 0)


'Step 9 : Execute Click  at Top-Left Corner
'##########################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Execute Click  at Top-Left Corner on MobiSwitch."
'Environment("StepsToReproduce") = Environment("StepsToReproduce") & Environment("StepName") & "." & intStep & ": " &_
...
'Step 9 : Execute Click  at Top-Right Corner
'##########################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Execute Click  at Top-Right Corner on MobiSwitch."
'Environment("StepsToReproduce") = Environment("StepsToReproduce") & Environment("StepName") & "." & intStep & ": " &_
'"Execute Click with Boundary Co-ordinates on MobiSwitch." & VBNewLine
Environment("ExpectedResult") = "Click should work correctly."
blnFlag = VerifyClick(objMobiSwitch, "withboundarycoordstopright")

'Step 9 : Execute Click  at Bottom-Left Corner
'##########################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Execute Click  at Bottom-Left Corner on MobiSwitch."
'Environment("StepsToReproduce") = Environment("StepsToReproduce") & Environment("StepName") & "." & intStep & ": " &_
'"Execute Click with Boundary Co-ordinates on MobiSwitch." & VBNewLine
Environment("ExpectedResult") = "Click should work correctly."
blnFlag = VerifyClick(objMobiSwitch, "withboundarycoordsbottomleft")

'Step 9 : Execute Click  at Bottom-Right Corner
'##########################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Execute Click  at Bottom-Right Corner on MobiSwitch."
'Environment("StepsToReproduce") = Environment("StepsToReproduce") & Environment("StepName") & "." & intStep & ": " &_
'"Execute Click with Boundary Co-ordinates on MobiSwitch." & VBNewLine
Environment("ExpectedResult") = "Click should work correctly."
...
arrProperty = Array("nativeclass")
arrPropertyValue = Array("android.widget.ToggleButton")
...
arrProps = Array("enabled","visible")
arrPropval = Array("True","True")
blnFlag = VerifyGetTOProperties(objMobiSwitch,arrProps)
...
blnFlag = VerifyGetTOProperty(objMobiSwitch, arrProps, arrPropval)
...
blnFlag = VerifySetTOProperty(objMobiSwitch, arrProps)
...
NavigateScreenOnPhoneLookupNative "Controls"  , objMobiSwitch , "Switch" , objList
