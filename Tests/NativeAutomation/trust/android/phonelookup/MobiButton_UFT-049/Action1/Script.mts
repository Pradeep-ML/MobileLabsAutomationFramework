...
' Hide device keypad in case of native automation
...
arrROProp =  Array("nativeclass","enabled")
arrROPropVal =  Array("android.widget.Button","True")
arrTOProp =  Array("accessibilitylabel","Visible")
arrTOPropVal =  Array("loginButton","True")
...
blnStepRC = VerifyCheckProperty(objMobiButton, "visible", "True", 5000, True)
...
blnStepRC = VerifyGetROProperty(objMobiButton,arrROProp,arrROPropVal)
...
blnStepRC = VerifyGetTOProperty(objMobiButton,arrTOProp,arrTOPropVal)
...
blnStepRC = VerifyWaitProperty(objMobiButton, "accessibilitylabel", "loginButton", 5000, True)

'Navigate to Search screen to verify object  property when not visible
...
"Execute WaitProperty on MobiButton." & VBNewLine
Environment("ExpectedResult") = "WaitProperty should wait for the property to attain a value but shouldn't report the result."
blnStepRC = VerifyWaitProperty(objMobiButton, "accessibilitylabel", "loginButton", 5000, False)
