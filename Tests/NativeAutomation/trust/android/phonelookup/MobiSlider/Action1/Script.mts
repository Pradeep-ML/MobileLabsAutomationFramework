...
'#######################################################
'' MobiSlider is functional only for Android 7 & above. 
...
NavigateScreenOnPhoneLookupNative "Controls" , objMobiSlider , "SeekBar", ObjList
...
arrROProp = Array("minvalue" , "maxvalue")
arrROPropVal = Array(0,100)
strResult = VerifyGetROProperty(objMobiSlider , arrROProp , arrROPropVal)
...
arrTOProps = Array("accessibilitylabel", "visible","minvalue","maxvalue")
strResult = VerifyGetTOProperties(objMobiSlider, arrTOProps)
...
arrTOProps = Array("accessibilitylabel", "visible","minvalue","maxvalue")
arrTOPropValues = Array("seek" , "true",0,100)
strResult = VerifyGetTOProperty(objMobiSlider, arrTOProps, arrTOPropValues)
...
strResult = VerifySetTOProperty(objMobiSlider, arrTOProps)
