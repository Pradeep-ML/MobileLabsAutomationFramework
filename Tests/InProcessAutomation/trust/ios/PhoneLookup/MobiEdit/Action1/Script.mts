...
blnFlag = VerifyWaitProperty(MobiDevice("PhoneLookup").MobiEdit("Username"), "visible", "True", 5000, True)
...
Environment("ExpectedResult") = "WaitProperty should wait for the property to attain a value but shouldn't report the result."
'MobiDevice("PhoneLookup").MobiEdit("Username").Set "WaitProperty"
blnFlag = VerifyWaitProperty(MobiDevice("PhoneLookup").MobiEdit("Username"), "value", "False", 5000, False)
