...
' Step 37:  Execute Swipe eDOWN with eFAST having valid start and end percentage
'#######################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Execute Swipe eDOWN with eFAST having valid start and end values on MobiList."
'Bringing list to Base state before swipe
objMobList.Scroll eTOP 
If MobiDevice("PhoneLookup").GetROProperty("devicetype") = "iPad" Then
 Set ObjAfterSwipeDown = MobiDevice("PhoneLookup").MobiElement("UITabBar")
Else	
Set ObjAfterSwipeDown = MobiDevice("PhoneLookup").MobiList("lstControls").MobiElement("UIScrollView")
End If

'Environment("StepsToReproduce") = Environment("StepsToReproduce") & Environment("StepName") & "." & intStep & ": " &_
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a mobile list"
blnFlag = VerifySwipe(objMobList , eDOWN,eFAST , 20,70,ObjAfterSwipeDown)


' Step 38:  Execute Swipe eUP with eSLOW
'#######################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Execute Swipe eUP  and velocity eSLOW and valid start and end percentage on MobiList."
...
' Step 39:  Execute Swipe eDOWN  and valocity eMEDIUM
'#######################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = " Execute Swipe eDOWN  and velocity eMEDIUM  on MobiList."
'Set ObjAfterSwipe = MobiDevice("PhoneLookup").MobiList("lstControls").MobiElement("ListControlBottom")
'Environment("StepsToReproduce") = Environment("StepsToReproduce") & Environment("StepName") & "." & intStep & ": " &_
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a mobile list"
blnFlag = VerifySwipe(objMobList ,eDOWN,eMEDIUM,20,70, ObjAfterSwipeDown)
...
blnFlag = VerifySwipe(objMobList ,eDOWN,eSLOW,20,70, ObjAfterSwipeDown)
...
'Set ObjAfterSwipe = MobiDevice("PhoneLookup").MobiElement("UITabBar")
blnFlag = VerifySwipe(objMobList ,eDOWN,eFAST,, 70, ObjAfterSwipeDown)
...
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a mobile list"
blnFlag = VerifySwipe(objMobList ,eUP ,eMEDIUM,, 70, ObjAfterSwipe)
...
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a mobile list"
blnFlag = VerifySwipe(objMobList ,eDOWN,eSLOW,, 70, ObjAfterSwipeDown)
...
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a mobile list"
blnFlag = VerifySwipe(objMobList ,eUP ,eSLOW,, 70, ObjAfterSwipe)
...
blnFlag = VerifySelect(objMobList, "selectstring", "UIWebview" , objImageAfterSelection)
GoToScreeniOS "controls"
