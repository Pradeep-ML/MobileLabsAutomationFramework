...
If MobiDevice("PhoneLookup").GetROProperty("osversion") = "11.0" Then
	Set ObjControls = MobiDevice("PhoneLookup").MobiElement("Controls")
Else
	Set ObjControls = MobiDevice("PhoneLookup").MobiButton("Controls")
End If
...
arrROProps = Array( "text" ,"enabled")
arrROvalues = Array("UILabel", False)
...
Environment("StepsToReproduce") = Environment("StepsToReproduce") & Environment("StepName") & "." & intStep & ": " &_
"Execute Swipe on MobiElement." & VBNewLine
Environment("Description") = "Execut swipe with direction as eup and velocity slow"
