...
blnFlag = VerifySwipe(objMobiDevice , eDOWN , ,30,,ObjAfterSwipeDown)
...
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a MobiDevice"
blnFlag = VerifySwipe(objMobiDevice ,eDOWN,eFAST,30,, ObjAfterSwipeDown)
...
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a MobiDevice"
blnFlag = VerifySwipe(objMobiDevice ,eDOWN,eMEDIUM,40,, ObjAfterSwipeDown)
...
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a MobiDevice"
blnFlag = VerifySwipe(objMobiDevice ,eDOWN,eSLOW,30,, ObjAfterSwipeDown)
...
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a MobiDevice"
blnFlag = VerifySwipe(objMobiDevice ,eDOWN,eFAST, , 80, ObjAfterSwipeDown)
...
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a MobiDevice"
blnFlag = VerifySwipe(objMobiDevice ,eDOWN,eSLOW, 30, 80, ObjAfterSwipeDown)
...
'"Execute Swipe on MobiList." & VBNewLine
Environment("ExpectedResult") = "Simulates a gesture on a MobiDevice"
blnFlag = VerifySwipe(objMobiDevice ,eDOWN,eMEDIUM, 30, 80, ObjAfterSwipeDown)
...
strResult = VerifyScale(objMobiDevice,40)
'###############################################################
EndTestIteration
