...
'Step 9 : Execute Click  with Boundary Co-ordinates at Top-Left corener
'##########################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Execute Click  with Boundary Co-ordinates at Top-Left corener on MobiSwitch."
'Environment("StepsToReproduce") = Environment("StepsToReproduce") & Environment("StepName") & "." & intStep & ": " &_
...
blnFlag = VerifyClick(objMobiSwitch, "withboundarycoordstopleft")

'Step 9 : Execute Click  with Boundary Co-ordinates at Top-Right corener
'##########################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Execute Click  with Boundary Co-ordinates at Top-Right corener on MobiSwitch."
'Environment("StepsToReproduce") = Environment("StepsToReproduce") & Environment("StepName") & "." & intStep & ": " &_
'"Execute Click with Boundary Co-ordinates on MobiSwitch." & VBNewLine
Environment("ExpectedResult") = "Click should work correctly for Boundary Co-ordinates."
blnFlag = VerifyClick(objMobiSwitch, "withboundarycoordstopright")

'Step 9 : Execute Click  with Boundary Co-ordinates at Bottom-Left corener
'##########################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Execute Click  with Boundary Co-ordinates at Bottom-Left corener on MobiSwitch."
'Environment("StepsToReproduce") = Environment("StepsToReproduce") & Environment("StepName") & "." & intStep & ": " &_
'"Execute Click with Boundary Co-ordinates on MobiSwitch." & VBNewLine
Environment("ExpectedResult") = "Click should work correctly for Boundary Co-ordinates."
blnFlag = VerifyClick(objMobiSwitch, "withboundarycoordsbottomleft")

'Step 9 : Execute Click  with Boundary Co-ordinates at Bootom-Right corener
'##########################################################
intStep = intStep+1
Environment("StepName") = "Step" & intStep
Environment("Description") = "Execute Click  with Boundary Co-ordinates at Bootom-Right corener on MobiSwitch."
'Environment("StepsToReproduce") = Environment("StepsToReproduce") & Environment("StepName") & "." & intStep & ": " &_
'"Execute Click with Boundary Co-ordinates on MobiSwitch." & VBNewLine
Environment("ExpectedResult") = "Click should work correctly for Boundary Co-ordinates."
blnFlag = VerifyClick(objMobiSwitch, "withboundarycoordsbottomright")
...
arrROProp = Array("visible" , "accessibilitylabel","resourcename")
arrROPropValue = Array(True,"controltogglebutton","controltogglebutton")
blnFlag = VerifyGetROProperty(objMobiSwitch,arrROProp,arrROPropValue)
...
arrTOProp = Array("enabled","accessibilitylabel","visible")
blnFlag = VerifyGetTOProperties(objMobiSwitch,arrTOProp)
...
arrTOProp = Array("enabled","accessibilitylabel","visible")
arrTOPropValue = Array(True,"controltogglebutton",True)
blnFlag = VerifyGetTOProperty(objMobiSwitch, arrTOProp, arrTOPropValue)
...
blnFlag = VerifySetTOProperty(objMobiSwitch, arrTOProp)
