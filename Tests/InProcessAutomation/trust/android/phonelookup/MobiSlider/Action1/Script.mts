...
arrROProp = Array("minvalue" , "maxvalue","resourcename")
arrROPropVal = Array(0,100,"seek")
...
arrTOProp = Array("minvalue", "maxvalue","accessibilitylabel")
strResult = VerifyGetTOProperties(objMobiSlider, arrTOProp)
...
arrTOProp = Array("minvalue", "maxvalue","accessibilitylabel","visible")
arrTOPropVal = Array(0, 100 , "seek", True)
strResult = VerifyGetTOProperty(objMobiSlider, arrTOProp, arrTOPropVal)
...
strResult = VerifySetTOProperty(objMobiSlider, arrTOProp)
