...
Set ObjToVerify = MobiDevice("Web Browser").MobiList("lstDropdown")
blnStepRC = VerifyClickDropdown(objMobiWebDropdown,ObjToVerify, "withoutcoords")
...
blnStepRC = VerifyClickDropdown(objMobiWebDropdown,ObjToVerify, "withrandomcoords")
...
blnStepRC = VerifyClickDropdown(objMobiWebDropdown,ObjToVerify , "withboundarycoordsTopLeft")
...
blnStepRC = VerifyClickDropdown(objMobiWebDropdown,ObjToVerify, "withboundarycoordsTopRight")
...
blnStepRC = VerifyClickDropdown(objMobiWebDropdown, ObjToVerify ,"withboundarycoordsBottomLeft")
...
blnStepRC = VerifyClickDropdown(objMobiWebDropdown,ObjToVerify , "withboundarycoordsBottomRight")
...
blnStepRC = VerifyClickDropdown(objMobiWebDropdown,ObjToVerify, "withxvalue")
...
blnStepRC = VerifyClickDropdown(objMobiWebDropdown,ObjToVerify, "withyvalue")
